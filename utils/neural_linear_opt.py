...
class NeuralLinear(object):
    ...
    def train_blr(self, train_loader_in, train_loader_out, criterion, optimizer, epoch):
    ...
    def train_oe(self, train_loader_in, train_loader_out, criterion, optimizer, epoch):
        batch_time = AverageMeter()
        out_confs = AverageMeter()
        in_confs = AverageMeter()
        in_losses = AverageMeter()
